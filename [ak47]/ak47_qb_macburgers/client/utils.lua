...
RegisterNetEvent('ak47_qb_macburgers:notify')
AddEventHandler('ak47_qb_macburgers:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_macburgers:progress')
AddEventHandler('ak47_qb_macburgers:progress', function(msg, time)
