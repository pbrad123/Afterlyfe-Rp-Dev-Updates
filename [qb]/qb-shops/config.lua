...
Config.Products = {
    ['normal'] = {
        ...
        {name = 'jolly_candy',   price = 100,   amount = 5000, info = {}, type = 'item'},
        {name = 'sprite',   price = 250,   amount = 5000, info = {}, type = 'item'},
        {name = 'double_cup',   price = 500,   amount = 5000, info = {}, type = 'item'},
    },
    ['liquor'] = {
        {name = 'beer',    price = 7,  amount = 50, info = {}, type = 'item'},
        {name = 'whiskey', price = 10, amount = 50, info = {}, type = 'item'},
    ...
    ['hardware'] = {
        ...
        {name = 'repairkit',         price = 250, amount = 50,  info = {}, type = 'item'},
        ...
        {name = 'advancedrepairkit', price = 500, amount = 50,  info = {}, type = 'item'},
        {name = 'slaptable',         price = 200, amount = 5,  info = {}, type = 'item'},
    },
    ['weedshop'] = {
        ...
        {name = 'pooch_bag',  price = 1000,   amount = 1000, info = {}, type = 'item'},
        {name = 'plastic_wrap',  price = 1000,   amount = 1000, info = {}, type = 'item'},
    },    
    ['gearshop'] = {
    ...
    ['blackmarket'] = {
        { name = "weapon_case",                     price = 0, amount = 900, info = {}, type = "item"},
        { name = "weapon_blueprint_pistol",         price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_snspistol",      price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_vintagepistol",  price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_appistol",       price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_pistol50",       price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_heavypistol",    price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_microsmg",       price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_minismg",        price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_sawnoffshotgun", price = 0, amount = 100, info = {}, type = "item"},
        { name = "weapon_blueprint_assaultrifle",   price = 0, amount = 100, info = {}, type = "item"},
        { name = "gunpowder",                       price = 0, amount = 900, info = {}, type = "item"},
        { name = "brass",                       price = 0, amount = 900, info = {}, type = "item"},
    },
    ['weapons'] = {
        ...
        {name = 'pistol_ammo',          price = 250,  amount = 250, info = {}, type = 'item'},
        {name = 'weapon_pistol',        price = 2500, amount = 5,   info = {}, type = 'weapon'},
        {name = 'weapon_snspistol',     price = 1500, amount = 5,   info = {}, type = 'weapon'},
        {name = 'weapon_vintagepistol', price = 4000, amount = 5,   info = {}, type = 'weapon'},
    },
    ['casino'] = {
        {name = 'casinochips', price = 1, amount = 999999, info = {}, type = 'item'}
    },
    ['pharmacy'] = {
        {name = 'medicalbag', price = 0, amount = 50, info = {}, type = 'item'},
        {name = 'medicinebox', price = 0, amount = 50, info = {}, type = 'item'}
    },
}
...
Config.Locations = {
    ...
    ['247supermarket'] = {
        ...
        ['coords'] = vector4(29.41, -1342.67, 29.5, 176.06),
    ...
    ['247supermarket2'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(-3044.84, 587.49, 7.91, 291.22),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket3'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(-3246.55, 1005.05, 12.83, 272.33),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket4'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(1733.83, 6417.52, 35.04, 160.23),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket5'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(1961.69, 3746.42, 32.34, 207.03),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket6'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(545.07, 2666.07, 42.16, 6.06),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket7'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(2676.15, 3285.61, 55.24, 240.57),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket8'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(2552.67, 385.62, 108.62, 272.87),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['247supermarket9'] = {
        ['label'] = '24/7 Supermarket',
        ['coords'] = vector4(377.95, 329.92, 103.57, 157.44),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['ltdgasoline'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(-47.41, -1752.3, 29.42, 137.03),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['ltdgasoline2'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(-710.43, -909.73, 19.22, 180.02),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['ltdgasoline3'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(-1825.98, 794.21, 138.19, 225.77),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['ltdgasoline4'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(1159.89, -319.59, 69.21, 198.31),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['ltdgasoline5'] = {
        ['label'] = 'LTD Gasoline',
        ['coords'] = vector4(1703.38, 4923.97, 42.06, 71.96),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['robsliquor'] = {
        ['label'] = 'Rob\'s Liqour',
        ['coords'] = vector4(-1220.65, -907.47, 12.33, 34.95),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['robsliquor2'] = {
        ['label'] = 'Rob\'s Liqour',
        ['coords'] = vector4(-1487.3, -376.88, 40.16, 135.77),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['robsliquor3'] = {
        ['label'] = 'Rob\'s Liqour',
        ['coords'] = vector4(-2966.33, 392.48, 15.04, 85.35),
        ['ped'] = 'mp_m_shopkeep_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-shopping-basket',
    ...
    ['hardware'] = {
        ...
        ['coords'] = vector4(68.95, -1569.93, 29.6, 43.59),
    ...
    ['ammunation2'] = {
        ['label'] = 'Ammunation',
        ['type'] = 'weapon',
        ['coords'] = vector4(815.82, -2157.61, 28.93, 88.52),
        ['ped'] = 's_m_y_ammucity_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
    ...
    ['ammunation6'] = {
        ['label'] = 'Ammunation',
        ['type'] = 'weapon',
        ['coords'] = vector4(16.81, -1105.16, 29.11, 256.01),
        ['ped'] = 's_m_y_ammucity_01',
        ['scenario'] = 'WORLD_HUMAN_COP_IDLES',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-gun',
    ...
    -- pharmacy Locations
    ['pharmacy'] = {
        ['label'] = 'Ambulance Pharmacy',
        ['coords'] = vector4(-140.45, -600.13, 38.14, 72.27),
        ['ped'] = 's_m_m_scientist_01',
        ['scenario'] = 'WORLD_HUMAN_STAND_MOBILE_CLUBHOUSE',
        ['radius'] = 1.5,
        ['targetIcon'] = 'fas fa-leaf',
        ['targetLabel'] = 'Ambulance Pharmacy',
