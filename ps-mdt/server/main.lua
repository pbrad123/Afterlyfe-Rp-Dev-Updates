...
local MugShotWebhook = 'https://discord.com/api/webhooks/1242304787618205776/HWcyIUeAnhAXn06FGyvwA0NN2dJ0ffxzbbS7BRDpGEgb4rf5HTP-JJohD9tw1hUeOuCM'

-- Clock-in notifications for duty. Add a Discord webhook.
-- Command /mdtleaderboard, will display top players per clock-in hours.
local ClockinWebhook = 'https://discord.com/api/webhooks/1223520967872221316/VbsUVdTLaAc3hW3UGH3x4KhkDEpJNxfHGpF4OeILfxHxOhynXXkuPNwFZVDyTdpmlYZ7'

-- Incident and Incident editting. Add a Discord webhook.
-- Incident Author, Title, and Report will display in webhook post.
local IncidentWebhook = 'https://discord.com/api/webhooks/1242304211681546291/SO4a_sa-1Nnk6fPYVGxqhrfe93jBvR_7YUi6qoP7c_wG-f2XUkvYS1XiNg-yDNwYq1QU'
--------------------------------
