...
Config.Elevators = {
    PillboxElevatorNorth = { -- Elevator name(Doesn't show it's just to name table)
        [1] = {
            coords = vec3(332.16, -595.97, 43.28), -- Coords, if you're new; last number is heading
        ...
        [2] = {
            coords = vec3(338.64, -583.88, 74.17), -- Coords, if you're new; last number is heading
            heading = 252.84,
            title = 'Floor 1',
            description = 'roof',
            target = {
