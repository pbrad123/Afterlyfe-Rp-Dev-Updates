...
Config.Shop = {
	...
	data = {
		...
		pagination = {						-- Create pages to your market items (max 10 pages)
			[0] = {name = "Taco", icon = 'fa-basket-shopping'},
			[1] = {name = "Burritos", icon = 'fa-basket-shopping'},
			[2] = {name = "Combo", icon = 'fa-basket-shopping'},
			[3] = {name = "Quesadilla", icon = 'fa-basket-shopping'},
			[4] = {name = "Desserts", icon = 'fa-basket-shopping'},
			[5] = {name = "Drinks", icon = 'fa-basket-shopping'},
		}
	}
}