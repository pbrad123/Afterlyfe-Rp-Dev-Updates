Config.Wardrobe = {
	script = 'auto', 	--Auto detect or ['qb-clothing','ak47_qb_clothing','raid_clothes','rcore_clothes','illenium-appearance', 'codem-apperance']
	
	Objects = { 		--Object listed here will be considered as Wardrobe
