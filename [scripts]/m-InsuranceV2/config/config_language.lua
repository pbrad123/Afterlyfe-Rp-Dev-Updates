...
Language = {
    ...
    repairVehProg = "Repairing vehicle...",
    ...
    vehNoInsurance = "The vehicle dont have insurance",
    vehYesInsurance = "The vehicle have insurance",
    noVehicleNearby = "No vehicle nearby",
    clickHere = "🔹Click here to recover your documents",
    notDriver = "You need to be the driver of the vehicle",
