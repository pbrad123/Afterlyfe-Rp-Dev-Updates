...
AdminPanel.ResetItemsList = function() {
    ...
    if (AdminPanel.Framework != "esx") {
        $("#itemslistthead").append(`
            ...
            <th scope="col"><span>${AdminPanel.Language.itemDescriptionTranslation}</span></th>
            <th scope="col"><span>${AdminPanel.Language.itemWeightTranslation}</span></th>
            </tr>
        `);
    }else{
        $("#itemslistthead").append(`
    ...
    for(const Item in AdminPanel.ItemsList) {
        if (AdminPanel.Framework != "esx") {
            ...
            <td>${AdminPanel.ItemsList[Item].label}</td>
            <td style="cursor: pointer" id="${Item}" class="ItemDblC">${Item}</td>
            <td>${AdminPanel.ItemsList[Item].weight} KG</td>
            </tr>
        `);
        }
    }
    ...
    if(AdminPanel.Framework == "esx") {
        $("#vehicleslistthead").append(`
            <tr>
                ...
                <th scope="col"><span>${AdminPanel.Language.vehPriceTranslation}</span></th>
            </tr>
        `);
    } else {
        $("#vehicleslistthead").append(`
            <tr>
                ...
                <th scope="col"><span>${AdminPanel.Language.vehmakeTranslation}</span></th>
                <th scope="col"><span>${AdminPanel.Language.vehCategoryTranslation}</span></th>
                <th scope="col"><span>${AdminPanel.Language.vehShopTranslation}</span></th>
                <th scope="col"><span>${AdminPanel.Language.vehPriceTranslation}</span></th>
            </tr>
        `);
    }
...
AdminPanel.Refresh = function(data) {
    ...
    AdminPanel.PlayerList.forEach(function (item, index) { 
        ...
        $("#mainplayerlist2").append(
            `<tr class="player" ${css} data-playerindex="${index}" data-id="${item.id}"><th scope="row">${item.id}</th><td>${item.name}</td><td>${item.charname}</td><td>${item.steamid}</td></tr>`
        );
    });
