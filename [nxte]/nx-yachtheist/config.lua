...
Config.Hack1Repeat = 1 -- how many times player has to do the hack for success

-- hack 2
Config.Hack2Item = 'electronickit'-- item needed for hack 1 
Config.Hack2Time = 60 -- amount of time player has to do the hack
Config.Hack2Squares = 4 -- amount of squares player has to hack
Config.Hack2Repeat = 1 -- how many times player has to do the hack for success
