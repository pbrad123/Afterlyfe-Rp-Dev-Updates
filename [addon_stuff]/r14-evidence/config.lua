...
Config.Debug = {
    ...
    Evidence = {enabled = true, label = "Print evidence creation to console.", order = 1}, -- enable this to print debug information when normal evidence is created
    CarEvidence = {enabled = true, label = "Print car evidence creation to console.", order = 2}, -- enable this to print debug information when car evidence is created
    Database = {enabled = true, label = "Print database events to server console.", server = true, order = 3}, -- enable this to print debug information related to vehicle evidence being uploaded to the database
    Bucket = {enabled = true, label = "Print current bucket to console.", order = 4}, -- enable this to print debug information relating to routing buckets here
    ViewEvidence = {enabled = true, label = "View evidence without camera or police job", order = 5}, -- enable seeing evidence at all times without use of camera for testing
    PrintBAC = {enabled = true, label = "Print the contents of the PlayerBAC table to server console during loop", server = true, order = 7}, -- this will print the PlayerBAC table every loop
    PrintTamperLoop = {enabled = true, label = "Print the contents of the Vehicle Tamper tables to server console during loop", server = true, order = 8}, -- this will print the PlayerBAC table every loop
    PrintStatus = {enabled = true, label = "Print the contents of the player status table to server console during loop", server = true, order = 9}, -- this will print the player status table every loop
    PrintFade =  {enabled = true, label = "Print evidence expiring to server console", server = true, order = 10}, -- this will print evidence pieces being removed by the time check loop to server console
    PrintTest = {enabled = true, label = "Print result of player checks/tests to server console", server = true, order = 11}, -- print results of BAC, GSR, frisks, and investigates to server console
    PrintTestC = {enabled = true, label = "Print data sent to player check/test events to console.", order = 12}, -- print data sent to BAC, GSR, frisks, and investigates to console
    OutlineCasings = {enabled = true, label = "Draw entity outline for shell casing objects", order = 13}, -- print data sent to BAC, GSR, frisks, and investigates to console
    ConfirmDrugPositive = {enabled = true, label = "Create server print and notify player when they test positive for a drug.", order = 14}, -- print/notify when a player returns positive for a drug to assist in testing drug/consumables integration
    PrintEventTriggerArgs = {enabled = true, label = "Print the arguments for your alochol and drug triggers to server console", server = true, order = 15}, -- this will print event trigger args to server console
}
...
Config.Framework = {
    ...
    CustomUpdateEvents = { -- this will define events where the script will update player data, you should include events triggered on load, unload, job updates, or character switch
         Server = { -- these are for events triggered on the server side
            ['exampleframework:switchCharacter'] = true,
         },
         Client = { -- these are for events triggered on the client side
             ['exampleframwork:updateJob'] = true,
         }, 
    },
}

Config.Inventory = {
    Ox = false, -- use this for ox inventory
    QB = true, -- use this for qb/lj and other qb-core compatible inventories that make use of the native player functions
...
Config.Target = {
    Ox = false, -- use this for ox_target
    QB = true, -- use this for qb-target
    Custom = false, -- set this to a string which matches your targeting resource name
}

Config.Context = {
    Ox = false, -- use this for ox_lib
    QB = true, -- use this for qb-menu/input
...
Config.Notification = {
    ...
    CantBleed = 'You cannot do this so soon, please wait',
    LeftFingerprint = 'You press your finger against the exterior of the vehicle and leave a fingerprint',
    Gloves = 'This person seems to be wearing gloves',
    GottenGloves = 'This person seems to be wearing gloves now???',
    NoWeapon = 'You do not seem to be holding a weapon',
    CleanWeapon = 'You clean the weapon to the best of your ability...',
    WipeWeapon = 'You wipe down the weapon as best as you can...',
    WipedDownArea = 'You wiped down the area as best as you could...',
    UploadedToMDT = 'Image uploaded to Report %s', -- requires one %s for the report number
    UploadedToImageSpace = 'Image uploaded to %s', -- requires one %s for the image space name
    DidNotFindReport = 'Incident # does not exist, please try again.' -- for when upload to MDT fails to find an incident number
}
...
Config.AuthorizedJobs = {
    LEO = { -- this is for job checks which should only return true for police officers
        Jobs = {['police'] = true, ['offpolice'] = true, ['fib'] = true},
...
Config.CarStatusList = {
    ...
    ['bloody'] = 'are covered in blood',
    ['blox'] = 'smell of bleach'
}
...
Config.CarWash = {
    Settings = {
        ...
        useQBdrawtext = true, -- will use built in QB draw text function
        useOXdrawtext = false, -- will use ox_lib text UI
        Price = 20,
        Label3D = '~g~E ~w~- Use Car Wash',
        Label2D = '[E] - Use Car Wash',
    ...
    Blip = {
        ...
        Scale = 0.75,
        Color = 37,  
        Name = 'Automatic Touchless Carwash', 
    },
    Interior = {
        Label = 'Vehicle Detailing',
        Description = 'Get a suck & buff!',
    },
    Exterior = {
        Label = 'Vehicle Cleaning',
        Description = 'Get a wash & wax!',
    },
    Locations = {
        [1] = {
