Prison = {
    ...
    FrameworkTriggers = {
        ...
        resourceNamePhone = 'roadphone', -- '[ 'qb-phone', 'npwd', 'gksphone', 'qs-smartphone'] Set the phone resource name for booth usage, if left blank, automatic detection will be performed
    },
    ...
    Accounts = {
        CreditsItem = 'cigar', -- Item which is defined as Prison enocomy item
