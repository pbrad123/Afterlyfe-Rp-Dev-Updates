...
RegisterNetEvent('ak47_qb_taco:notify')
AddEventHandler('ak47_qb_taco:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_taco:progress')
AddEventHandler('ak47_qb_taco:progress', function(msg, time)
