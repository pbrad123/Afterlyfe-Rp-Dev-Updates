...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ['Legion Square'] = { -- If you change the name of this garage from Legion Square, you must change the default value of `garage_id` to the same name in the SQL table `players_vehicles`
    ...
    spawn = {vector4(212.27, -800.16, 30.88, 334.76)}, --  you can add multiple spawn locations into a table
    distance = 15,
    type = "car",
    blip = {
      id = 357,
  ...
  ['Docks'] = {
    coords = vector3(1090.83, -3130.33, 5.9),
    spawn = vector4(1104.1, -3129.83, 5.9, 89.33),
    distance = 15,
    type = "car",
    blip = {
      id = 357,
...
Config.GangGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ['Black Wolves Mc'] = {
    coords = vector3(-2188.92, 4265.15, 48.77),
    spawn = vector4(-2193.12, 4258.90, 48.27, 102),
    distance = 5,
    gang = "wolves",
    type = "car",
    blip = {
    ...
    hideMarkers = true,
    markers = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
    vehiclesType = "gang", -- Use personal vehicles
  }
}
