...
RegisterNetEvent('ak47_qb_pizzashop:notify')
AddEventHandler('ak47_qb_pizzashop:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_pizzashop:progress')
AddEventHandler('ak47_qb_pizzashop:progress', function(msg, time)
