Config = {
	...
	Main = { -- Main variables
		...
		JobRoles = { "mechanic", "redline", "autoexotics", "harmony", "paleto", "bennys","sport"}, -- These are the job roles who can use items if RequiresJob is enabled.
	...
	Odometer = {
		...
		speedCustomisation = {
			...
			HighSpeedHighlight = false,								-- Highlight high speeds on the speedometer
			...
			showRpmMeter = false,									-- Show RpmMeter
			...
			showFuelMeter = false,									-- Show FuelMeter
	...
	Emergency = {
		...
		Locations = {
			{ coords = vec4(-297.74, -1049.65, 23.28, 249.1), prop = true, }, -- MRPD UNDERGROUND PARKING
			{ coords = vec4(-111.04, -615.95, 36.27, 247.99), prop = true, }, -- PILL BOX GARAGE
			{ coords = vec4(-505.84, -610.27, 30.30, 85), prop = true }, -- state
			{ coords = vec4(1846.58, 3700.73, 34.27, 33), prop = true }, -- bcso
			{ coords = vec4(962.1, -1481.21, 30.97, 270.76), prop = true }, -- sadot/towing
			{ coords = vec4(-1899.47, -314.93, 49.4, 236.72), prop = true }, -- Ocean Hosiptal
		},
	...
	Discord = { -- Discord preview receipts
		...
		DiscordDefault = "https://discord.com/api/webhooks/1228071284466909254/lEXH2L7mpEQqB2QW9Y12LF3jX5I378yDJyR1N3gwkgGTqEnqyBr0YUXzooNqPrr7rbDl", 		-- Set this to the default channel API link if one isn't set for a location
