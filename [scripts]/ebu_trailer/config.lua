...
Config.UseExternalTrailerConnect = true    -- Set to True if you want to use ebu_trailerconnect with the whitelist/blacklist control
--========Interaction Type========--
...
Config.Trailers = {
    [GetHashKey('bcthauler2')] = {
        ...
        rampPos = {vector3(3603.33, -860.92, 32.17), vector3(3600.47, -859.94, 32.17)},
        rampextraNum = 1,
        rampDoorNum = 2,
    },

    [GetHashKey('Diamondtriaxle')] = { 
        hasRamp = true,
        
        rampPos = {vector3(3572.79, -842.71, 32.17),vector3(3574.97, -840.2, 32.17)},
        rampextraNum = 1,
        rampDoorNum = 2,
    },


    [GetHashKey('dirtystrailer')] = {        
        hasRamp = true,
        
        rampPos = {vector3(3578.65, -859.41, 32.17),vector3(3580.83, -861.45, 32.17)},
        rampextraNum = 1,
        rampDoorNum = 5,
        
    },
    [GetHashKey('rrtrailer')] = { 
        hasRamp = true,
        
        rampPos = {vector3(3579.76, -860.49, 32.17),vector3(3581.93, -857.78, 32.17)},
        rampextraNum = 1,
        rampDoorNum = 5,
    },
    [GetHashKey('godzcoe')] = {
