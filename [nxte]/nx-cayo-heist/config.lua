...
------------------------------------------------ HEIST ----------------------------------------------------------
Config.MinCop = 0 -- min amount of cops needed for the heist to be able to stawrt
...
Config.Hack1Time = 60 -- amount of time player has to do the hack 
...
Config.Hack2TimeShow = 60 --time in secs for which the right blocks will be shown
Config.Hack2TimeHack = 60 --maximum time after timetoshow expires for player to select the right blocks

-- hack 3
Config.Hack3Item = 'trojan_usb' -- item needed to do hack 1 
Config.Hack3Time = 60 -- amount of time player has to do the hack 
...
-- door hack 
Config.BombTimer = 5 -- how long the bomb needs to explode
...
Config.BombTimeShow = 60 --time in secs for which the right blocks will be shown
Config.BombTimeHack = 60 --maximum time after timetoshow expires for player to select the right blocks
