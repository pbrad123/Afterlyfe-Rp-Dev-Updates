...
Config.ShowBlips = true
	...
	[3] = {pos = vector3(199.9, -2002.26, 18.86), sprite = 496, color = 2, size = 1.3, radius = 50.0, name = 'Weed Lab'},
	...
	[15] = {pos = vector3(1656.76, 4.62, 166.12), sprite = 93, color = 27, size = 1.3, radius = 50.0, name = 'Lean Lab'},
	[16] = {pos = vector3(1665.03, 2.04, 166.12), sprite = 499, color = 2, size = 0.62, radius = 0.0, name = 'Lean Lab'},
...
Config.Teleports = {
	...
	['Meth Lab'] = {enter = vector3(2483.83, 3445.8, 51.07), exit = vector3(1538.88, 6321.92, 25.06)},
}