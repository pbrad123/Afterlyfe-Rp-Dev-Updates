...
-- cop requirement
Config.MinCop = 0 -- Min amount of cops needed to do mission  
...
Config.Hack1Time = 60 -- amount of time to do the hack in seconds
Config.Hack1Squares = 4 -- Amount of squares to hack 
Config.Hack1Repeat = 1 -- Amount of times you need to hack to succeed 

-- hack 2
Config.Hack2Item = 'trojan_usb' -- item needed for 2nd hack

Config.Hack2Blocks = 6 -- Number of correct blocks the player needs to click 
Config.Hack2Fails = 3 -- Number of incorrect blocks after which the game will fail
Config.Hack2Time = 60 -- time in secs for which the right blocks will be shown
Config.Hack2Timer = 60 -- maximum time after timetoshow expires for player to select the right blocks

-- Hack 3
Config.Hack3Item = 'gatecrack' -- item needed for 3th hack

Config.Hack3Time = 60 -- amount of time to do the hack in seconds
