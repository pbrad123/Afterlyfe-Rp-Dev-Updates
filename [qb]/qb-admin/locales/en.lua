Translations = {
    html = {
        ...
        FeedSelfTranslate = "FILL FOOD/WATER",
        ...
        itemWhoToGiveTranslation = "Who do you want to give the item to?<br/>LEAVE BLANK IF YOURSELF",
    ...
    alerts = {
        ...
        sentToPillbox = "Sent player to Pillbox hospital.",
        ...
        freeaimTog = "Freeaim mode toggled.",
