...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "miningdrill",	price = 500, amount = 50, info = {}, type = "item", slot = 6, },
			{ name = "mininglaser",	price = 1000, amount = 5, info = {}, type = "item", slot = 7, },
			{ name = "drillbit", price = 0, amount = 100, info = {}, type = "item", slot = 8, },
			{ name = "pickaxe",	price = 0, amount = 100, info = {}, type = "item", slot = 9, },
		},
	},
}
Crafting = {
