...
function GateOneTHAnim() 
    ...
    TriggerServerEvent('nui_doorlock:server:updateState', "Gateone",  false, false, false, true)
    AddExplosion(
        -1305.75, 
        -820.10, 
        18.35, 
...
function GateOneTHSuccess()
    ...
    TriggerServerEvent('nui_doorlock:server:updateState', "baycitysideexit",  true, false, false, true)
    TriggerServerEvent('nui_doorlock:server:updateState', "baycityfrontexit",  true, false, false, true)
...
function GateTwoTHAnim() 
    ...
    TriggerServerEvent('nui_doorlock:server:updateState', "Gatetwo",  false, false, false, true)
    AddExplosion(
        -1307.81, 
        -814.12, 
        18.35, 
...
function GateTwoTHSuccess()
    ...
    if #(pos - vector3(Config.Locations["GateTwoTH"].x, Config.Locations["GateTwoTH"].y,Config.Locations["GateTwoTH"].z)) < 1.5 then
        TriggerServerEvent("Jakers-BayCity-heist:server:SetGateTwoTHStatus", "isDone", true)
        TriggerServerEvent("Jakers-BayCity-heist:server:SetGateTwoTHStatus", "isBusy", false)
    end
    TriggerServerEvent("QBCore:Server:RemoveItem", "thermite", 1)
    TriggerEvent('inventory:client:ItemBox', QBCore.Shared.Items["thermite"], "remove")
...
RegisterNetEvent('Jakers-BayCity:client:petpanther',function()
	...
	--lockdowndoors
    TriggerServerEvent('nui_doorlock:server:updateState', "baycitysideexit",  false, false, false, true)
    TriggerServerEvent('nui_doorlock:server:updateState', "baycityfrontexit",  false, false, false, true)
end)
...
AddEventHandler("jakers-baycity-heist:CleanUpBayCity", function()
    ...
    TriggerServerEvent('nui_doorlock:server:updateState', "Gateone",  true, false, false, true)
    TriggerServerEvent('nui_doorlock:server:updateState', "Gatetwo",  true, false, false, true)
     --lockdowndoors
    TriggerServerEvent('nui_doorlock:server:updateState', "baycitysideexit",  false, false, false, true)
    TriggerServerEvent('nui_doorlock:server:updateState', "baycityfrontexit",  false, false, false, true)
end)
