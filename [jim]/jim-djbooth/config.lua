...
Config = {
	...
	Locations = {
		...
		{ -- LostMC compound next to Casino
			...
			DefaultVolume = 0.1,
			radius = 50,
			coords = vec3(1414.1, 4680.59, 133.94),
			soundLoc = vec3(1414.1, 4680.59, 133.94), -- Add sound origin location if you don't want the music to play from the dj booth
			prop = `prop_boombox_01`
		},
		{ -- LostMC compound next to Casino
		    job = "staff",
			...
			DefaultVolume = 0.1,
			radius = 20,
			coords = vec3(-1764.53, -261.87, 49.12),
			soundLoc = vec3(-1764.53, -261.87, 49.12), -- Add sound origin location if you don't want the music to play from the dj booth
			prop = `prop_coffin_01`
		},
		{ -- LostMC compound next to Casino
		    job = "staff",
			...
			DefaultVolume = 0.1,
			radius = 5000,
			coords = vec3(3633.22, -878.5, 32.17),
			soundLoc = vec3(3633.22, -878.5, 32.17), -- Add sound origin location if you don't want the music to play from the dj booth
			prop = `prop_boombox_01`
		},
	},
}
