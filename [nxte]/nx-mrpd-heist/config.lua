...
-- mrpd heist
Config.MinCop = 0 -- minimin amount of on duty officers to be able to do the heist
...
Config.HackTime = 60 -- time player has to do the hack
...
-- bomb
Config.BombTime = 10 -- timer that bomb needs to explode in seconds
