Citizen.CreateThread(function()
	if Config.Wardrobe.script == 'auto' then
		...
		if GetResourceState('codem-apperance') == 'started' or GetResourceState('codem-apperance') == 'starting' then
			Config.ClothingScript = 'codem-apperance'
			return
		end
...
AddEventHandler('ak47_qb_housing:openwardrobe', function(houseid, objectid)
	...
	elseif Config.Wardrobe.script == 'codem-apperance' then
