...
Config.MinCop = 0 -- minimum cops needed to be able to do the heist
...
Config.HackTime = 60 -- time player has to complete the hack 
Config.HackSquares = 2 -- amount of squares the player has to hack
Config.HackRepeat = 1 -- amount of times player has to complete the hack

-- bomb
Config.BombItem = 'thermite' -- item needed to be able to place the bomb
Config.BombTime = 5 -- time in sec the bomb needs to explode after placing it 
