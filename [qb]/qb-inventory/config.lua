...
Config.MaxInventoryWeight = 1200000                           -- Max weight a player can carry (default 120kg, written in grams)
Config.MaxInventorySlots = 60                                -- Max inventory slots for a player
