...
RegisterNetEvent('ak47_qb_burgershop:notify')
AddEventHandler('ak47_qb_burgershop:notify', function(msg)
    QBCore.Functions.Notify(msg)
end)

RegisterNetEvent('ak47_qb_burgershop:progress')
AddEventHandler('ak47_qb_burgershop:progress', function(msg, time)
