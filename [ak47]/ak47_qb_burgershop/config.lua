...
Config.Shop = {
	blip = {enable = true, name = 'Burgershot', sprite = 536, color = 1, size = 1.0, radius = 0.0, radius_color = 4},															-- job name
	...
	data = {
		market_items = {					-- Here you configure the items definitions
			bacon_double_cheeseburger = {				-- The item ID
				name = "Double Bacon Supreme",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			bacon_ham_sausage = {				-- The item ID
				name = "Bacon Ham Sausage",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			big_fish = {				-- The item ID
				name = "Ocean Catch Sandwich",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			bs_chicken_jr = {				-- The item ID
				name = "Junior Chicken Delight",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			...
			buttermilk_biscuit = {				-- The item ID
				name = "Buttermilk Biscuit",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			deluxe_chicken_sandwich = {				-- The item ID
				name = "Royal Chicken Deluxe Sandwich",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			...
			rodeo_burger = {				-- The item ID
				name = "Western BBQ Burger",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			...
			texas_double_whopper = {				-- The item ID
				name = "Lone Star Double Whopper",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
			whopper_with_cheese = {				-- The item ID
				name = "Triple Cheese Whopper",	-- The item display name
				page = 0,					-- Set on which page this item will appear
				process = true
			},
