...
vehicles = {
    [`camaroRB`] = { -- These are examples, please edit these and add your own vehicles
        name = "Response Car",
        boneName = "bumper_f",
        offSet = {0.0, 0.76, -0.4},
...
grapplerCommand = {
    ...
    QBCore = {
        ...
        checkJob = {
            ...
            jobs = {"police", "sast", "bcso", "sasp"}, -- A user can have any of the following jobs, meaning you can add different jobs
        },
        checkPermission = {
